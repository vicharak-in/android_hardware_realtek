...
//  {0x8822,            HCI_VERSION_MASK_ALL,    HCI_REVISION_MASK_ALL, CHIP_TYPE_MASK_ALL,  1<<8,                  "rtl8822bs_fw",         "rtl8822bs_config",     CONFIG_MAC_OFFSET_GEN_3PLUS,  MAX_PATCH_SIZE_24K},   //Rtl8822BS
    ...
    {0x8822,            HCI_VERSION_MASK_ALL,    (1<<0xe),              CHIP_TYPE_MASK_ALL,  1ULL<<33,              "rtl8822es_fw",         "rtl8822es_config",     CONFIG_MAC_OFFSET_GEN_4PLUS,  MAX_PATCH_SIZE_145K},     //Rtl8822ES
...
static void rtk_get_bt_final_patch(bt_hw_cfg_cb_t* cfg_cb)
{
    ...
    {
        ALOGE("hw_cfg_cb.project_id_mask is 0x%16llx, fw project_id is %d, does not match!!!",
                     (long long)  hw_cfg_cb.project_id_mask, proj_id);
        cfg_cb->dl_fw_flag = 0;
        goto free_buf;
    }
